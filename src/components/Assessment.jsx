  ...
  return (
    <div className='assesment-title'>
      ...
      <div className='asssesment-info'>
        <div className='col'>
          <div className='as-title'><Text family='Unbounded' weight={700}>Інноваційність</Text></div>
        ...
        <div className='col'>
        <div className='as-title'><Text family='Unbounded' weight={700}>Компетентність</Text></div>
          <div className='as-desc'><Text family='Mulish' weight={400}>&#8226; Кваліфікація виконавців, загальна адміністративна та технічна спроможність.</Text></div>
        </div>
        <div className='col'>
          <div className='as-title'><Text family='Unbounded' weight={700}>Стійкість</Text></div>
          <div className='as-desc'><Text family='Mulish' weight={400}>&#8226; Наявність моделі самопідтримки;</Text>
